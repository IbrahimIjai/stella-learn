...
import { Horizon, Networks, TransactionBuilder, Operation, Asset, Memo, BASE_FEE, Transaction } from '@stellar/stellar-sdk'
...
export class StellarHelper {
  ...
  constructor(network: 'testnet' | 'mainnet' = 'testnet') {
    ...
    StellarWalletsKit.init({
      network: this.networkPassphrase as any,
  ...
  async sendPayment(params: {
    ...
    const result = await this.server.submitTransaction(
      transactionToSubmit as Transaction,
    )
